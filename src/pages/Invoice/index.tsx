...
function AcInput({
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div
          className={`absolute z-30 top-full mt-1 w-full rounded-xl border overflow-hidden shadow-xl ${
            isDark
...
function Toast({
  ...
  return (
    <div
      className={`fixed bottom-6 right-6 z-50 flex items-center gap-2 px-4 py-3 rounded-xl bg-[#1a1826] text-white text-sm font-medium shadow-2xl transition-all duration-300 ${
              ...
              clients.map((c) => (
                <div
                  ...
                  className={`flex items-center justify-between p-3 rounded-xl border ${
                    isDark ? "border-white/6 bg-white/2" : "border-black/6 bg-black/1"
                  }`}
                >
                  <div>
        ...
        >
          <div className="max-w-[1400px] mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              {/* Save indicator */}
              <div
                className={`hidden sm:flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-lg transition-all ${
                  saveState === "saved"
                    ? "text-emerald-500 bg-emerald-500/10"
                    : saveState === "saving"
                    ? isDark ? "text-white/30 bg-white/4" : "text-black/30 bg-black/4"
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-6">
          <div
            className={`flex gap-6 ${
              showPreview ? "md:grid md:grid-cols-[1fr_420px]" : ""
            }`}
          >
            {/* ═══ FORM / HISTORY PANEL ══════════════════════════════════ */}
            <div
              ...
              {!showHistory && (
                <>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <Field label="Invoice Number *" half>
                        <div className="flex gap-2">
                          ...
                          <button
                            onClick={() => set("invoiceNumber", generateInvoiceNumber())}
                            className={`px-2.5 rounded-xl text-xs transition-colors shrink-0 ${
                              isDark
                      ...
                      <Field label="Currency" half>
                        <div className="relative">
                          ...
                          {currencyOpen && (
                            <div
                              className={`absolute z-20 top-full mt-1 w-full rounded-xl border overflow-hidden shadow-xl ${
                                isDark
                                  ? "bg-[#161618] border-white/10"
                                  : "bg-white border-black/8"
                              }`}
                  ...
                  <div className={cardCls}>
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-[2fr_1fr_1fr_1fr_1fr_80px_36px] gap-2 items-start">
                              ...
                              <div
                                className={`px-3 py-2.5 rounded-xl text-sm font-semibold text-right ${
                                  isDark
                    ...
                    {/* Totals */}
                    <div
                      className={`mt-5 ml-auto w-full sm:w-80 rounded-xl border p-4 space-y-2 ${
                        isDark ? "border-white/6 bg-white/2" : "border-black/6 bg-black/2"
                      }`}
                    >
                      <div className={`flex justify-between text-sm ${isDark ? "text-white/50" : "text-black/50"}`}>
                        <span>Subtotal</span>
